...
const colorSchemes = {
  ...
  solarizedDark: {
    key: "FO.ColorSchemeSolarizedDark",
    // blue 1F88D2
    // cream FDF6E3
    // almost black 002B36
    // gray light 93A1A1
  ...
  solarizedLight: {
    key: "FO.ColorSchemeSolarizedLight",    
    accent: "#B58900",
    background: "#FDF6E3",
...
export const applyFontsAndColors = () => {
  ...
  r.style.setProperty("--fo-cybertext-color", colorScheme.cybertext);
