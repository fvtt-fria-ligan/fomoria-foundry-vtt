...
export class FOCombatModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
...
export class FOCombat extends Combat {
  /**
   * @inheritdoc
   */
  static async create(data = {}, operation) {
    // Always create with type: 'cy' so we can use the FOCombatModel
    return super.create({ ...data, type: "fomoria" }, operation);
  }
